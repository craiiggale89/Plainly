...
const initialMessage: Message = {
    role: 'assistant',
    content: "👋 Hi! I'm here to help you figure out how AI might work for your business.\n\nAre you curious about training your team on AI tools, building something custom, or just exploring what's possible?",
}
                ...
                <div className="chat-window">
                    <div className="chat-header">
                        <div className="chat-header-info">
                            ...
                            <span className="chat-header-status">Ask us anything</span>
                        </div>
                    </div>
